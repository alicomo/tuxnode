...
abstract class BaseServiceForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'feature_name'  => new sfWidgetFormInputText(),
      'feature_value' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'feature_name'  => new sfValidatorString(array('max_length' => 255)),
      'feature_value' => new sfValidatorString(array('max_length' => 255)),
